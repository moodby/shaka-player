...
shaka.net.HttpFetchPlugin = class {
  ...
  static async request_(uri, requestType, init, abortStatus, progressUpdated,
    ...
    window.postMessage(JSON.stringify({
      ...
      'traceActivity':
        'shaka.net.HttpFetchPlugin.request_',
      'uri': uri,
    ...
    try {
      ...
      window.postMessage(JSON.stringify({
        'type': 'MOODBY_TRACE_EVENT',
        'traceActivity':
          'shaka.net.HttpFetchPlugin.request_responseReceived',
        'uri': uri,
        'requestType': requestType,
      }));
    ...
    window.postMessage(JSON.stringify({
      'type': 'MOODBY_TRACE_EVENT',
      'traceActivity':
        'shaka.net.HttpFetchPlugin.request_returnMakeResponse',
      'uri': uri,
      'requestType': requestType,
      'responseStauts': response.status,
