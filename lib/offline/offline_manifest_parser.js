...
shaka.offline.OfflineManifestParser = class {
  ...
  async start(uriString, playerInterface) {
    window.postMessage(JSON.stringify({
      ...
      'traceActivity': 'shaka.offline.OfflineManifestParser.start',
      'uriString': uriString,
    }));
    ...
    try {
      ...
      window.postMessage(JSON.stringify({
        'type': 'MOODBY_TRACE_EVENT',
        'traceActivity':
          'shaka.offline.OfflineManifestParser.startGetMuxedCell',
      }));
      ...
      window.postMessage(JSON.stringify({
        'type': 'MOODBY_TRACE_EVENT',
        'traceActivity':
          'shaka.offline.OfflineManifestParser.startGetCellManifests',
      }));
