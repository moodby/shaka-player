...
shaka.Player = class extends shaka.util.FakeEventTarget {
  ...
  load(assetUri, startTime, mimeType) {
    window.postMessage(JSON.stringify({
      'type': 'MOODBY_TRACE_EVENT',
      'traceActivity': 'shaka.Player.load',
      'startTime': startTime,
      'mimeType': mimeType,
      'assetUri': assetUri,
    }));
  ...
  onAttach_(has, wants) {
    window.postMessage(JSON.stringify({
      'type': 'MOODBY_TRACE_EVENT',
      'traceActivity': 'shaka.Player.onAttach_',
    }));
    ...
    window.postMessage(JSON.stringify({
      'type': 'MOODBY_TRACE_EVENT',
      'traceActivity': 'shaka.Player.onAttach_Resolve',
    }));
  ...
  onDetach_(has, wants) {
    window.postMessage(JSON.stringify({
      'type': 'MOODBY_TRACE_EVENT',
      'traceActivity': 'shaka.Player.onDetach_',
    }));
    ...
    window.postMessage(JSON.stringify({
      'type': 'MOODBY_TRACE_EVENT',
      'traceActivity': 'shaka.Player.onDetach_Resolve',
    }));
    return Promise.resolve();
  }
  ...
  async onUnload_(has, wants) {
    window.postMessage(JSON.stringify({
      'type': 'MOODBY_TRACE_EVENT',
      'traceActivity': 'shaka.Player.onUnload_',
    }));
    ...
    window.postMessage(JSON.stringify({
      'type': 'MOODBY_TRACE_EVENT',
      'traceActivity': 'shaka.Player.onUnload_cleanupTasks',
      'tasksLength': cleanupTasks.length,
    }));
    await Promise.all(cleanupTasks);
    window.postMessage(JSON.stringify({
      'type': 'MOODBY_TRACE_EVENT',
      'traceActivity': 'shaka.Player.onUnload_cleanupTasksResolved',
      'tasksLength': cleanupTasks.length,
    }));
    ...
    window.postMessage(JSON.stringify({
      'type': 'MOODBY_TRACE_EVENT',
      'traceActivity': 'shaka.Player.onUnload_Finished',
    }));
  }
  ...
  async onInitializeMediaSourceEngine_(has, wants) {
    window.postMessage(JSON.stringify({
      'type': 'MOODBY_TRACE_EVENT',
      'traceActivity': 'shaka.Player.onInitializeMediaSourceEngine_',
    }));
    goog.asserts.assert(
    ...
    window.postMessage(JSON.stringify({
      'type': 'MOODBY_TRACE_EVENT',
      'traceActivity':
        'shaka.Player.onInitializeMediaSourceEngine_open',
    }));
    ...
    window.postMessage(JSON.stringify({
      'type': 'MOODBY_TRACE_EVENT',
      'traceActivity':
        'shaka.Player.onInitializeMediaSourceEngine_openResolved',
    }));
    ...
    window.postMessage(JSON.stringify({
      'type': 'MOODBY_TRACE_EVENT',
      'traceActivity':
        'shaka.Player.onInitializeMediaSourceEngine_Finished',
    }));
  }
  ...
  async onInitializeParser_(has, wants) {
    window.postMessage(JSON.stringify({
      'type': 'MOODBY_TRACE_EVENT',
      'traceActivity': 'shaka.Player.onInitializeParser_',
    }));
    goog.asserts.assert(
        has.mediaElement,
    ...
    window.postMessage(JSON.stringify({
      'type': 'MOODBY_TRACE_EVENT',
      'traceActivity': 'shaka.Player.onInitializeParser_Finished',
    }));
  }
  ...
  onParseManifest_(has, wants) {
    window.postMessage(JSON.stringify({
      'type': 'MOODBY_TRACE_EVENT',
      'traceActivity': 'shaka.Player.onParseManifest_',
    }));
    goog.asserts.assert(
        has.mimeType == wants.mimeType,
    ...
    return new shaka.util.AbortableOperation(/* promise= */ (async () => {
      window.postMessage(JSON.stringify({
        'type': 'MOODBY_TRACE_EVENT',
        'traceActivity': 'shaka.Player.onParseManifest_parser_.start',
      }));
      this.manifest_ = await this.parser_.start(assetUri, playerInterface);
      window.postMessage(JSON.stringify({
        'type': 'MOODBY_TRACE_EVENT',
        'traceActivity': 'shaka.Player.onParseManifest_parser_.startResolved',
      }));
      ...
      window.postMessage(JSON.stringify({
        'type': 'MOODBY_TRACE_EVENT',
        'traceActivity': 'shaka.Player.onParseManifest_Finished',
      }));
    })(), /* onAbort= */ () => {
      window.postMessage(JSON.stringify({
        'type': 'MOODBY_TRACE_EVENT',
        'traceActivity': 'shaka.Player.onParseManifest_Aborting',
      }));
  ...
  async onInitializeDrm_(has, wants) {
    window.postMessage(JSON.stringify({
      'type': 'MOODBY_TRACE_EVENT',
      'traceActivity': 'shaka.Player.onInitializeDrm_',
    }));
    goog.asserts.assert(
        has.mimeType == wants.mimeType,
    ...
    window.postMessage(JSON.stringify({
      'type': 'MOODBY_TRACE_EVENT',
      'traceActivity': 'shaka.Player.onInitializeDrm_initForPlayback',
    }));
    ...
    window.postMessage(JSON.stringify({
      'type': 'MOODBY_TRACE_EVENT',
      'traceActivity': 'shaka.Player.onInitializeDrm_initForPlaybackResolved',
    }));
    window.postMessage(JSON.stringify({
      'type': 'MOODBY_TRACE_EVENT',
      'traceActivity': 'shaka.Player.onInitializeDrm_attach',
    }));
    await this.drmEngine_.attach(has.mediaElement);
    window.postMessage(JSON.stringify({
      'type': 'MOODBY_TRACE_EVENT',
      'traceActivity': 'shaka.Player.onInitializeDrm_attachResolved',
    }));

    window.postMessage(JSON.stringify({
      'type': 'MOODBY_TRACE_EVENT',
      'traceActivity': 'shaka.Player.onInitializeDrm_filterManifest_',
    }));
    ...
    window.postMessage(JSON.stringify({
      'type': 'MOODBY_TRACE_EVENT',
      'traceActivity': 'shaka.Player.onInitializeDrm_filterManifest_Resolved',
    }));
    window.postMessage(JSON.stringify({
      'type': 'MOODBY_TRACE_EVENT',
      'traceActivity': 'shaka.Player.onInitializeDrm_Finished',
    }));
  }
  ...
  async onLoad_(has, wants) {
    window.postMessage(JSON.stringify({
      'type': 'MOODBY_TRACE_EVENT',
      'traceActivity': 'shaka.Player.onLoad_',
      'hasMimeType': has.mimeType,
      'wantsMimeType': wants.mimeType,
      'hasUri': has.uri,
      'wantsUri': wants.uri,
    }));
    goog.asserts.assert(
    ...
    window.postMessage(JSON.stringify({
      'type': 'MOODBY_TRACE_EVENT',
      'traceActivity': 'shaka.Player.onLoad_createSegmentIndexPromises',
      'createSegmentIndexPromisesLength': createSegmentIndexPromises.length,
    }));
    ...
    window.postMessage(JSON.stringify({
      'type': 'MOODBY_TRACE_EVENT',
      'traceActivity': 'shaka.Player.onLoad_createSegmentIndexPromisesResolved',
      'createSegmentIndexPromisesLength': createSegmentIndexPromises.length,
    }));
    ...
    window.postMessage(JSON.stringify({
      'type': 'MOODBY_TRACE_EVENT',
      'traceActivity': 'shaka.Player.onLoad_streamingEngine_.start',
    }));
    ...
    window.postMessage(JSON.stringify({
      'type': 'MOODBY_TRACE_EVENT',
      'traceActivity': 'shaka.Player.onLoad_streamingEngine_.startResolved',
    }));
    ...
    window.postMessage(JSON.stringify({
      'type': 'MOODBY_TRACE_EVENT',
      'traceActivity': 'shaka.Player.onLoad_fullyLoaded_',
    }));
  ...
  async onInitializeSrcEqualsDrm_(has, wants) {
    window.postMessage(JSON.stringify({
      'type': 'MOODBY_TRACE_EVENT',
      'traceActivity': 'shaka.Player.onInitializeSrcEqualsDrm_',
    }));
    ...
    window.postMessage(JSON.stringify({
      'type': 'MOODBY_TRACE_EVENT',
      'traceActivity':
        'shaka.Player.onInitializeSrcEqualsDrm_initForPlayback',
    }));
    await this.drmEngine_.initForPlayback(
    ...
    window.postMessage(JSON.stringify({
      'type': 'MOODBY_TRACE_EVENT',
      'traceActivity':
        'shaka.Player.onInitializeSrcEqualsDrm_initForPlaybackResolved',
    }));
    window.postMessage(JSON.stringify({
      'type': 'MOODBY_TRACE_EVENT',
      'traceActivity':
        'shaka.Player.onInitializeSrcEqualsDrm_attach',
    }));
    await this.drmEngine_.attach(has.mediaElement);
    window.postMessage(JSON.stringify({
      'type': 'MOODBY_TRACE_EVENT',
      'traceActivity':
        'shaka.Player.onInitializeSrcEqualsDrm_attachResolved',
    }));
    window.postMessage(JSON.stringify({
      'type': 'MOODBY_TRACE_EVENT',
      'traceActivity':
        'shaka.Player.onInitializeSrcEqualsDrm_Finished',
    }));
  }
  ...
  onSrcEquals_(has, wants) {
    window.postMessage(JSON.stringify({
      'type': 'MOODBY_TRACE_EVENT',
      'traceActivity': 'shaka.Player.onSrcEquals_',
    }));
    goog.asserts.assert(
        has.mediaElement,
        'We should have a media element when loading.');
    ...
    if (mediaElement.error) {
      window.postMessage(JSON.stringify({
        'type': 'MOODBY_TRACE_EVENT',
        'traceActivity':
          'shaka.Player.onSrcEquals_fullyLoaded.reject',
      }));
      // Already failed!
      ...
      window.postMessage(JSON.stringify({
        'type': 'MOODBY_TRACE_EVENT',
        'traceActivity':
          'shaka.Player.onSrcEquals_fullyLoaded.resolve',
      }));
    ...
    this.loadEventManager_.listenOnce(mediaElement, 'error', () => {
      window.postMessage(JSON.stringify({
        'type': 'MOODBY_TRACE_EVENT',
        'traceActivity':
          'shaka.Player.onSrcEquals_listenOnceFullyLoaded.reject',
      }));
      fullyLoaded.reject(this.videoErrorToShakaError_());
    });
    ...
    return new shaka.util.AbortableOperation(fullyLoaded, /* onAbort= */ () => {
      ...
      window.postMessage(JSON.stringify({
        'type': 'MOODBY_TRACE_EVENT',
        'traceActivity':
          'shaka.Player.onSrcEquals_Aborted',
      }));
      ...
      window.postMessage(JSON.stringify({
        'type': 'MOODBY_TRACE_EVENT',
        'traceActivity':
          'shaka.Player.onSrcEquals_Finished',
      }));
    });
  }
